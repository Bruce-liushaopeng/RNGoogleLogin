...
export default class LoginController extends Component {
  ...
  componentDidMount() {
    GoogleSignin.configure({
      webClientId: '765672974439-2gssr3k82oph27ghs1ok6dfv4fnutifu.apps.googleusercontent.com', 
      offlineAccess: true, 
      hostedDomain: '', 
          ...
          <ScrollView
            ...
            <View style={styles.body}>
              ...
              <View style={styles.buttonContainer}>
                {!this.state.loggedIn && <Text>{"You are currently logged out "+ this.state.loggedIn}</Text>}
